...
if __name__ == "__main__":
    ...
    #     deb.draw_bar(
    #         title="Actual Speed: ", value=bar2, color=deb.BAR_YELLOW, attrib="normal"
    #     )
    #     deb.draw_vertical_bar(
    #         title="vz ", value=bar, color=deb.BAR_WHITE, attrib="normal"
    #     )

    #     deb.draw_vertical_bar(
    #         title="vy ", value=0.5, color=deb.BAR_YELLOW, attrib="normal"
    #     )
